...
if __name__ == "__main__":
    ...
    # NOTE: syslog capture is no longer configured in Graylog directly.
    # Syslog now flows through Vector (UDP :12202) which enriches and
    # forwards to Graylog via GELF TCP alongside Docker container logs.
